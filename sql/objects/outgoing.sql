...
from
t_object o
join t_connector c on c.End_Object_ID = o.Object_ID and c.Direction in ('Source -> Destination', 'Unspecified', 'Both')
...
from
t_object o
join t_connector c on c.Start_Object_ID = o.Object_ID and c.Direction in ('Destination -> Source', 'Unspecified', 'Both')
